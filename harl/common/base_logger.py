...
class BaseLogger:
    ...
    def episode_log(
        ...
        if len(self.done_episodes_rewards) > 0:
            ...
            self.writter.add_scalar(
                "success_rate/02_train_episode_rewards", aver_episode_rewards, self.total_num_steps
            )
            self.done_episodes_rewards = []
    ...
    def eval_log(self, eval_episode):
        ...
        eval_env_infos = {
            "eval_info/00_eval_average_episode_rewards": self.eval_episode_rewards,
            "eval_info/01_eval_average_episode_speeds": self.eval_episode_speeds,
            "eval_info/02_eval_average_episode_accelerations": self.eval_episode_accelerations,
            "eval_info/03_eval_max_episode_rewards": [np.max(self.eval_episode_rewards)],
            "eval_info/04_eval_mean_episode_speed": [np.mean(self.eval_episode_speeds)],
            "eval_info/05_eval_mean_episode_acceleration": [np.mean(self.eval_episode_accelerations)],
        }
